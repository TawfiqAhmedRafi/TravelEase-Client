...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-base-100 shadow-sm px-5 md:px-8 ">
      <div className="navbar-start">
        ...
        <div className="flex items-center">
            ...
            <Link to="/" className=" outline-0 fredoka-font font-semibold  text-xl">Travel<span className="text-secondary">Ease</span>  </Link>
        </div>
  ...
  <input
    type="checkbox"
    onChange={(e) => {
      const newTheme = e.target.checked ? "travelsease_dark" : "travelsease_light";
